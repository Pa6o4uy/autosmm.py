...
Здесь вы найдете важные ссылки для работы с плагином и сервисами SMM.
    ...
    kb_.row(
        InlineKeyboardButton("👨‍💻 Крутой парень", url="https://t.me/Pa6o4uy"),
        InlineKeyboardButton("💬 Поддержка", url="https://t.me/Pa6o4uy")
    )

    kb_.row(
        InlineKeyboardButton("🌐 Twiboost", url="https://twiboost.com/ref2752118"),
        InlineKeyboardButton("🌐 Vexboost", url="https://vexboost.ru/ref2769600"),
        InlineKeyboardButton("🌐 SonarSmm", url="https://sonarsmm.store/ref3049781"),
        InlineKeyboardButton("🌐 Looksmm", url="https://looksmm.ru/ref3091494")
    )
...
Переменные: https://teletype.in/@pa6o4uy/WpPMgt6jgtz
